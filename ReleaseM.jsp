...
pageEncoding="UTF-8"%>
    ...
    <head>
        ...
        <title>
            TestAutomatic | TASense One Click Analytics - Release Management
        </title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="ProjectName-chart">
                    ...
                    <a class="reset" href="javascript:projectNameChart.filterAll();dc.redrawAll();" style="display: none">reset</a
          >
      ...
      <div class="row">
        ...
        <div id="DefectRootCause-chart">
          <strong>Defect RootCause</strong>
          <a
            class="reset"
      ...
      <div class="row">
        <div id="monthly-move-chart">
          <strong>No of Release in a year</strong>

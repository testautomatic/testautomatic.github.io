...
<title>Forgot TestAutomatic UserName</title>
			...
			<div class="container">
					...
					<div class="col-sm-6 col-sm-offset-3 form-box">
						<div class="form-top">
							<div class="form-top-left">
								<h3>Forgot Your TestAutomatic UserName ?</h3>
						...
						<div class="form-bottom">
							<form name="frm" id="formForgotPassword" role="form" class="formForgotPassword"
								action="ForgotUsername" method="post">
				...
				<div class="l-form-10-questions">
					...
					<a href="ContactUs.jsp">Contact Us To Buy License </a> |||-||| <a
						href="TryItNow.jsp">Return to Login</a> |||-|||

...
<body>
        ...
        <div class="inner-bg">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        ...
                        <div class="form-bottom">
                            <form name="frm" id="frm" role="form" class="login-form" action="DemoServlets" method="post">
                                <div class="form-group">
                                    <label class="sr-only" for="form-username"></label>
                                    <i class="inside fa fa-user fa-1x"></i>
                                    <input type="text" name="uname" placeholder="Username" minlength="3" maxlength="20" required class="inside-indent form-username form-control" id="username" />
                                </div>

                                <div class="form-group">
                                    <label class="sr-only" for="form-email">Email_ID</label>
                                    <i class="inside fa fa-envelope fa-1x"></i>
                                    <input type="email" name="email" pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}" required placeholder="Enter Your Email ID" class="inside-indent form-email form-control" id="email" />
                                </div>
                                <button type="submit" class="btn" value="submit" onclick="return checkform()" style="clear: both">
                    Login
                  </button>
                            </form>
                            <li>
                ...
                <div class="l-form-10-questions">
                    <p></p>
                    <a href="ContactUs.jsp">Contact Us To Buy License </a> |||-|||
    ...
    <script type="text/javascript" src="Welcome/js/jquery.backstretch.min.js"></script>

...
/* 		javaEmail.setMailServerProperties(); */
		String emailSubject = "[TA Contact Us] - " + request.getParameter("subject") ;
		String emailBody = "";
		...
		if (request.getParameter("subject") != null) {
			emailBody = emailBody + "Sender Subject: "
...
<title>TestAutomatic : Contact Us | An Agile Test Automation
	Tool</title>
<link rel="stylesheet" type='text/css'
	href="Welcome/css/bootstrap.min.css">
...
<script type="text/javascript">
function checkform() {
    if(document.frm.email.value == "" || document.frm.subject.value == "" || document.frm.message.value == "") {
...
<!-- 					<li><a href="TAAnalytics">Analytics</a></li> -->
				...
				<li><a href="ContactUs">Contact Us</a></li>
					<li><a href="https://testautomatic.atlassian.net/wiki/spaces/TESTAUTOMA/pages/262196/Introduction">Blog</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="container">
			...
			<div class="row">
				<div
					...
					<p>Contact us for queries, issues and your feedback. We will
						make sure to be up to your expectations!</p>
				</div>
			</div>
				...
				<div class="col-sm-6 col-sm-offset-3 wow fadeInUp">
					...
					<div id="message">
						<div class="c-form-1-bottom">
							<form name="frm" id="frm" role="form" action="ContactUs.jsp"
								method="post">
								<div class="form-group">
									<label class="sr-only" for="c-form-1-email">Email</label> <input
										type="text" name="email" placeholder="Your Email ID"
										class="c-form-1-email form-control" id="email" required>
								</div>
								<div class="form-group">
									<label class="sr-only" for="c-form-1-subject">Subject</label> <input
										type="text" name="subject" placeholder="Subject Line"
										class="c-form-1-subject form-control" id="subject" required>
								</div>
								<div class="form-group">
									<label class="sr-only" for="c-form-1-message">Message</label>
									<textarea name="message" placeholder="Your Message/Feedback"
										class="c-form-1-message form-control" id="message" required></textarea>
								</div>
								<!-- 		                        <button type="submit" class="btn">Send message</button>	      -->
								<div id="mail-status"></div>
								<button type="submit" class="btn" name="submit"
									onclick="return checkform()" style="clear: both;">Send
									Message</button>
								<p id="alertMessage"></p>
								<%
						if (null != message) {
							out.print("<i class=" + icon +" ></i>");
			...
			<div class="row">
				...
				<div class="col-sm-12 c-form-1-info-box wow fadeInUp">
					...
					<p>
						Email:<br> <a href="mailto:board@testautomatic.com">board@testautomatic.com</a>
					</p>
				</div>
			</div>
	...
	<footer>
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12 footer-copyright">&copy; 2016.
					TestAutomatic Technologies Private Limited. All Rights Reserved.</div>
			</div>
		</div>
	</footer>

...
tademo();
       function tademo() {
           // alert("inside TAdemo");
           window.location.href = 'https://testautomatic.com:9091/secure/Dashboard.jspa';
           window.history.pushState("https://testautomatic.com:9091/secure/Dashboard.jspa", "TA for JIRA", "https://testautomatic.com/Jiralogin");
           // window.history.pushState("https://testautomatic.com", "TA for JIRA", "https://www.testautomatic.com/hey");
           window.history.replaceState("https://testautomatic.com:9091/secure/Dashboard.jspa", "TA for JIRA", "https://testautomatic.com/Jiralogin");

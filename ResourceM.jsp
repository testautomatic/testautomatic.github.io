...
<title>TestAutomatic | TASense One Click Analytics - Resource
	Management</title>
...
<!-- 					<li><a href="AboutUs">About Us</a></li> -->
	...
	<div class="container">
		...
		<div class="row">
			...
			<div id="Domain-chart">
				<strong>Domain</strong> <a class="reset"
					href="javascript:domainChart.filterAll();dc.redrawAll();"
			...
			<div id="FundingType-chart">
				<strong>Funding</strong> <a class="reset"
			...
			<div id="ProgrammeName-chart">
				<strong>Programme</strong> <a class="reset"
			...
			<div id="WorkStream-chart">
				<strong>Work Stream</strong> <a class="reset"
		...
		<div class="row">
			...
			<div id="CostObject-chart">
				<strong>Cost Object</strong> <a class="reset"
			...
			<div id="ResourceName-chart">
				<strong>Resource Name</strong> <a class="reset"
			...
			<div id="GPN-chart">
				<strong>Employee ID</strong> <a class="reset"
			...
			<div id="OutsourceVendor-chart">
				<strong>Out Source Vendor</strong> <a class="reset"
			...
			<div id="OFFON-chart">
				<strong>OFF/ON details</strong> <a class="reset"
		...
		<div class="row">
			...
			<div id="yearly-bubble-chart" class="dc-chart">
				<strong>Yearly Resource Details</strong> <a class="reset"
			...
			<div id="FTEUtilization-chart" class="dc-chart">
				<strong>FTE Utilization Details</strong> <a class="reset"
		...
		<div class="row">
			...
			<div id="Location-chart">
				<strong>Location</strong> <a class="reset"
			...
			<div id="Role-chart">
				<strong>Role</strong> <a class="reset"
			...
			<div id="Rank-chart">
				<strong>Rank</strong> <a class="reset"
			...
			<div id="RoleSummary-chart">
				<strong>Role Summary</strong> <a class="reset"
		...
		<div class="row">
			...
			<div id="quarter-chart">
				<strong>Quarters</strong> <a class="reset"
			...
			<div id="OutSourceDayRate-chart">
				<strong>OutSource Day Rate</strong> <a class="reset"
			...
			<div id="RateOverride-chart">
				<strong>Rate Override</strong> <a class="reset"
			...
			<div id="AnnualCost-chart">
				<strong>Annual Cost</strong> <a class="reset"
			...
			<div id="TotalCost-chart">
				<strong>Total Cost</strong> <a class="reset"
		...
		<div class="row">
			<div id="monthly-move-chart">
				<strong>Yearly Status</strong> <span class="reset"

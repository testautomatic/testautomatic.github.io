...
<title>TestAutomatic : About Us | An Agile Test Automation Tool</title>
...
<link rel="stylesheet" type="text/css" href="Welcome/css/AboutUs.css">
...
<body>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="overlay-container overlay-visible">
							<img src="Welcome/images/backgrounds/aboutus.png" alt="">
							<div class="overlay-bottom hidden-xs">
								<div class="text">
									<h3 class="title">Your Inputs, Our Source Code</h3>
								</div>
							</div>
						</div>
					</div>
					<div class="full-text-container light-gray-bg border-bottom-clear">
						...
						<p class="profession">We have focused on providing the best
							user experience possible. We take great care to ensure that they
							will ultimately serve you, rather than our own internal goal or
							bottom line.We have focused on all the users who can just click
							the features and automate an web page without any prior
							experience to coding</p>

						<h3>Our Vision</h3>

						<p class="profession">We believe we have a responsibility to
							help our clients and communities, and are using our resources and
							expertise to help find solutions to key challenges in automation
							around the world.</p>

						<h3>Our Values</h3>

						<p class="profession">We know your time is valuable, so when
							you’re seeking an way to automate your webpage, we aim to please.
							We see being great at something as a starting point, not an
							endpoint. Through innovation, we aim to take things that work
							well and improve upon them in an unexpected way</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 footer-copyright">&copy; 2016. Test
				Automatic Technologies Private Limited. All Rights Reserved.</div>
		</div>
	</div>
	</footer>
